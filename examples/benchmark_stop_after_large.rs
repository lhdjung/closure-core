...
fn main() {
    ...
    let result =
        closure_parallel::<f64, i32>(3.0, 1.0, 100, 1, 5, 0.05, 0.05, 1, None, Some(1)).unwrap();
    ...
    let start = Instant::now();
    let result =
        closure_parallel::<f64, i32>(3.0, 1.0, 100, 1, 5, 0.05, 0.05, 1, None, Some(10)).unwrap();
    ...
    let start = Instant::now();
    let result =
        closure_parallel::<f64, i32>(3.0, 1.0, 100, 1, 5, 0.05, 0.05, 1, None, Some(100)).unwrap();
    ...
    let start = Instant::now();
    let result =
        closure_parallel::<f64, i32>(3.0, 1.0, 100, 1, 5, 0.05, 0.05, 1, None, Some(1000)).unwrap();
    ...
    let start = Instant::now();
    let result =
        closure_parallel::<f64, i32>(3.0, 1.0, 100, 1, 5, 0.05, 0.05, 1, None, None).unwrap();
    let duration_full = start.elapsed();
    println!("  Duration: {:?}", duration_full);
    println!("  Total samples: {}", result.results.len());
    println!();
