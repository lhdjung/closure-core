...
fn main() {
    ...
    let result = dfs_parallel::<f64, i32>(
        3.0,
        1.0,
        100,
        1,
    ...
    println!("Summary:");
    println!("  stop_after=1 is {:.2}x faster than full search",
             duration_full.as_secs_f64() / duration_1.as_secs_f64());
    println!("  stop_after=10 is {:.2}x faster than full search",
             duration_full.as_secs_f64() / duration_10.as_secs_f64());
    println!("  stop_after=100 is {:.2}x faster than full search",
             duration_full.as_secs_f64() / duration_100.as_secs_f64());
    println!("  stop_after=1000 is {:.2}x faster than full search",
