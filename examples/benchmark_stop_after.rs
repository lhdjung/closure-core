...
fn main() {
    ...
    println!("Summary:");
    println!("  stop_after=1 is {}x faster than full search",
             duration_full.as_secs_f64() / duration_1.as_secs_f64());
    println!("  stop_after=10 is {}x faster than full search",
             duration_full.as_secs_f64() / duration_10.as_secs_f64());
    println!("  stop_after=100 is {}x faster than full search",
