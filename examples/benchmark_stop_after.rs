...
fn main() {
    ...
    let result = closure_parallel::<f64, i32>(3.5, 0.5, 52, 1, 5, 0.05, 0.05, None, Some(1));
    ...
    let start = Instant::now();
    let result = closure_parallel::<f64, i32>(3.5, 0.5, 52, 1, 5, 0.05, 0.05, None, Some(10));
    ...
    let start = Instant::now();
    let result = closure_parallel::<f64, i32>(3.5, 0.5, 52, 1, 5, 0.05, 0.05, None, Some(100));
    ...
    let start = Instant::now();
    let result = closure_parallel::<f64, i32>(3.5, 0.5, 52, 1, 5, 0.05, 0.05, None, Some(1000));
    ...
    let start = Instant::now();
    let result = closure_parallel::<f64, i32>(3.5, 0.5, 52, 1, 5, 0.05, 0.05, None, None);
